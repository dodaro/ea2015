...
<div class="container">
	...
	<table>
		...
		<tr>
			<td><span class="text">Model:</span> ${userReview.car}</td>
		</tr>
		<tr>
			<td><span class="text">Color:</span> ${userReview.color}</td>
		</tr>
		<tr>
			<td><span class="text">Total Price:</span> ${userReview.totalPrice} Euro</td>
		</tr>
	</table>
